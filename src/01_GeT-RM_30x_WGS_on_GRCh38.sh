...
# manually prepared PGx regions based on "PharmCAT/pharmcat_positions.vcf" as of v1.5.1
PGX_GENE_REGION_FILE=pharmcat_positions_w_1Mbp_padding_v1.5.1.txt
...
# list files
CHR_LIST=(1 2 4 6 7 10 12 13 16 19)
